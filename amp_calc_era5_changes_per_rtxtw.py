...
era5_n_days_above_tx_99_per_rtet_ci = np.full([era5_huss_on_txx_full.latitude.size, era5_huss_on_txx_full.longitude.size, 2], np.nan)
...
era5_n_days_above_tw_99_per_rtet_ci = np.full([era5_huss_on_txx_full.latitude.size, era5_huss_on_txx_full.longitude.size, 2], np.nan)
...
for xlat in range(era5_huss_on_txx_full.latitude.size):
    ...
    for ylon in range(era5_huss_on_txx_full.longitude.size):
        ...
        if nn.size > 20:
            ...
            era5_n_days_above_tw_99_per_rtet_ci[xlat, ylon, 0] = mdl.conf_int(alpha=.05)[1,0]
            era5_n_days_above_tw_99_per_rtet_ci[xlat, ylon, 1] = mdl.conf_int(alpha=.05)[1,1]
...
#             era5_n_days_above_tw_90_per_rtet_r2[xlat, ylon] = mdl.rsquared
        ...
        if nn.size > 20:
            ...
            era5_n_days_above_tx_99_per_rtet_ci[xlat, ylon, 0] = mdl.conf_int(alpha=.05)[1,0]
            era5_n_days_above_tx_99_per_rtet_ci[xlat, ylon, 1] = mdl.conf_int(alpha=.05)[1,1]
...
with open('era5_n_days_above_tw_99_per_rtet_ci.dat', 'wb') as f:
    pickle.dump(era5_n_days_above_tw_99_per_rtet_ci, f)
...
with open('era5_n_days_above_tx_99_per_rtet_ci.dat', 'wb') as f:
    pickle.dump(era5_n_days_above_tx_99_per_rtet_ci, f)
