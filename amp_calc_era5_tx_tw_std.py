...
tx_std = tx_months_of_interest.std(dim='time')
tw_std = tw_months_of_interest.std(dim='time')


# Save the results to a netcdf file
output_file = f"output/tx_tw_std/tx_std_warm_season_{year}.nc"
tx_std.to_netcdf(output_file)

output_file = f"output/tx_tw_std/tw_std_warm_season_{year}.nc"
tw_std.to_netcdf(output_file)
